...
export default function DefaultSchema({ contact }) {
    ...
    <>
      <View style={{ flex: 1 }}>
        <ScrollView style={{ flex: 1 }}>
          ...
          {/* Company */}
          <Text style={{ textAlign: "center" }}>{contact.info.company}</Text>

          <View style={{ height: 30 }}></View>
          {/* Phone Numbers */}
          <PhoneNumbers numbers={contact.info.phoneNumbers} />
        </ScrollView>
      </View>
    </>
  );
...
const PhoneNumber = ({ numData }) => {
  ...
  return (
    <ListItem topDivider onPress={handlePress}>
