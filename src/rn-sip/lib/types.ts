...
export const extraHeadersPropType = PropTypes.object;
// PropTypes.objectOf([
...
export const callHistoryPropType = PropTypes.arrayOf(
  PropTypes.shape({
...
export const callInfoListPropType = PropTypes.arrayOf(
  PropTypes.shape({
    _id: PropTypes.string,
    _direction: PropTypes.string,
...
export const mediaDeviceListPropType = PropTypes.arrayOf(
  PropTypes.shape({
